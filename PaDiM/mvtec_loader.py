...
class MVTecDataset(Dataset):
    ...
    def _get_image_files(self):
        ...
        labels = []   # Binary labels: 0 for anomaly, 1 for normal
        ...
        if self.is_train:
            ...
            labels.extend([1] * len(img_files))      # 1 for normal samples
        else:
            ...
            for label in self.category_labels[self.category]:
                ...
                if label == 'good':
                    ...
                    labels.extend([0] * len(img_files))  # 0 for anomaly samples
